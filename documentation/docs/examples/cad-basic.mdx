...
Note that `html2canvas` is used to draw UI and this has some limitations on what CSS properties it is able to render. For details see https://html2canvas.hertzen.com/documentation.
