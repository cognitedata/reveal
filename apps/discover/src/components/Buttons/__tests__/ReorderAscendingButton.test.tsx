...
import { REORDER_ASCENDING_TOOLTIP } from '../constants';
import { ReorderButton } from '../ReorderButton';
import { BaseButtonProps } from '../types';

const BUTTON_TEXT = 'TestButtonText';

describe('Reorder Ascending Button', () => {
  const testInit = async (viewProps?: BaseButtonProps) =>
    testRenderer(ReorderButton.Ascending, undefined, viewProps);
  ...
  it('should render the default tooltip', async () => {
    ...
    await screen.findByText(REORDER_ASCENDING_TOOLTIP);
  });
