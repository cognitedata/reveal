...
export class Grid3 extends Shape {
  ...
  public /* override */ clone(): Shape {
    return new Grid3(this.nodeSize);
  }
  ...
  public getCellIndex2(i: number, j: number) {
  ...
  public isNodeInside(i: number, j: number, k: number) {
    return (
      i >= 0 &&
      j >= 0 &&
      k >= 0 &&
  ...
  public isCellInside(i: number, j: number, k: number) {
    return (
      i >= 0 &&
      j >= 0 &&
      k >= 0 &&
  ...
  public isCellInside3(cell: Index3) {
    return (
      cell.i >= 0 &&
      cell.j >= 0 &&
      cell.k >= 0 &&
      cell.i < this.cellSize.i &&
      cell.j < this.cellSize.j &&
      cell.k < this.cellSize.k
    );
  }
}
