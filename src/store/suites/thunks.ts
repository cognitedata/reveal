...
export const insertSuite = (client: CdfClient, apiClient: ApiClient, suite: Suite) => async (
  dispatch: RootDispatcher
) => {
...
export const deleteSuite = (client: CdfClient, apiClient: ApiClient, key: SuiteRowDelete[]) => async (
  dispatch: RootDispatcher
) => {
  try {
