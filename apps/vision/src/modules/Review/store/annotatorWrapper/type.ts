import { Keypoint, Status } from '../../../../api/annotation/types';
import { AnnotatorNewRegion } from '../../Components/ReactImageAnnotateWrapper/types';
import { PredefinedVisionAnnotations, Tool } from '../../types';
