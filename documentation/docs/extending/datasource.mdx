...
| `Cognite3DModel` \ `NodesApiClient` | `mapTreeIndicesToNodeIds()` | `mapNodeIdsToTreeIndices()` | `determineTreeIndexAndSubtreeSizesByNodeIds()` | `determineNodeAncestorsByNodeId()` | `getBoundingBoxByNodeId()` |
| ----------------------------------- | --------------------------- | --------------------------- | ---------------------------------------------- | ---------------------------------- | -------------------------- |
| `getBoundingBoxByNodeId()`          |                             |                             |                                                |                                    | X                          |
| `getBoundingBoxByNodeTreeIndex()`   | X                           |                             |                                                |                                    | X                          |
| `mapNodeIdToTreeIndex()`            |                             | X                           |                                                |                                    |                            |
| `mapNodeIdsToTreeIndices()`         |                             | X                           |                                                |                                    |                            |
| `mapTreeIndexToNodeId()`            | X                           |                             |                                                |                                    |                            |

## Unsupported features

** TODO **
- Point clouds - partially supported?
- Node styling based on CDF