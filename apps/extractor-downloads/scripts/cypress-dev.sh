...
pid_docker=$!
nx e2e extractor-downloads-e2e --watch --browser chrome --env.DATA_EXPLORER_CLIENT_ID="$client_id" --env.DATA_EXPLORER_CLIENT_SECRET="$client_secret" --env.OVERRIDE_URL=https://localhost:3010/index.js &
pid_cypress=$!
wait
