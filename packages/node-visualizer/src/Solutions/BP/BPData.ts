...
import {
  ITrajectory,
  TrajectoryId,
} from 'SubSurface/Wells/Interfaces/ITrajectory';
import {
...
export class BPData {
  ...
  private _wellBoreToWellMap = new Map<
    WellBoreId,
  ...
  private generateBoreToWellMap(
    wellBores: IWellBore[],
    metadataTransform?: MetadataTransformation<IWellBoreMeta>
  ) {
  ...
  private generateTrajectoryMap(trajectories: ITrajectory[]) {
    ...
    for (const trajectory of trajectories) {
      ...
      if (valid) this.trajectoryMap.set(trajectory.id, trajectory);
    }
  }

  private generateTrajectoryDataColumnIndexes(
    trajectoryData?: ITrajectoryRows[]
  ) {
    ...
    if (!columns || !columns.length) {
      console.warn(
        'First trajectory data item does not contain columns',
        trajectoryData
      );
      return;
    }
  ...
  //= =================================================
  public get wellMap() {
    return this._wellMap;
  }

  public get wellBoreToWellMap() {
    return this._wellBoreToWellMap;
  }

  public get trajectoryMap() {
    return this._trajectoryMap;
  }

  public get trajectoryDataColumnIndexes() {
    return this._trajectoryDataColumnIndexes;
  }

  public get trajectoryDataMap() {
    return this._trajectoryDataMap;
  }

  public get wellBoreToNDSEventsMap() {
    return this._wellBoreToNDSEventsMap;
  }

  public get wellBoreToNPTEventsMap() {
    return this._wellBoreToNPTEventsMap;
  }

  public get wellBoreToLogsMap() {
