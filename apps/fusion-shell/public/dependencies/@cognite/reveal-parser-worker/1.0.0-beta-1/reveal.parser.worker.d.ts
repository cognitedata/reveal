...
export declare class RevealParserWorker {
    parseSector(buffer: Uint8Array): Promise<ParseSectorResult>;
    parseCtm(buffer: Uint8Array): Promise<ParseCtmResult>;
    parseQuads(buffer: Uint8Array): Promise<SectorQuads>;
    private extractParsedPrimitives;
    private extractTriangleMeshes;
    private extractInstanceMeshes;
