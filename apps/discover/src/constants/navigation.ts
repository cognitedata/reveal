...
const ADMIN_LAYERS = `${ADMIN}/layers`;
const ADMIN_LAYERS_CREATE = `${ADMIN_LAYERS}/create`;
...
export default {
  ...
  SEARCH_WELLS_INSPECT_LOGTYPE: `${SEARCH_WELLS_INSPECT}/logType`,
  ...
  SEARCH_WELLS_INSPECT_GEOMECHANIC: `${SEARCH_WELLS_INSPECT}/geomechanic`,
  SEARCH_WELLS_INSPECT_MULTIPLEPPFG: `${SEARCH_WELLS_INSPECT}/multiplePPFG`,
