...
import { COLOR_BLACK, DEFAULT_PICK_WINDOW_SIZE } from '../rendering/constants';
import { ClipMode, PointCloudMaterial, PointColorType } from '../rendering';
...
export class PointCloudOctreePicker {
  ...
  private static readPixels(renderer: WebGLRenderer, x: number, y: number, pickWndSize: number): Uint8Array {
  ...
  private static updatePickRenderTarget(pickState: IPickState, width: number, height: number): void {
