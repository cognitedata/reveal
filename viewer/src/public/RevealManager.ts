...
export class RevealManager<TModelIdentifier> {
  ...
  public addUiObject(object: THREE.Group, screenPos: THREE.Vector2, width: number, height: number) {
    this._effectRenderManager.addUiObject(object, screenPos, width, height);
  }
