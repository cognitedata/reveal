...
export class Image360PointsObject extends Object3D {
    ...
    constructor(maxPoints: number, materialParameters: Pick<PointsMaterialParameters, "spriteTexture" | "minPixelSize" | "maxPixelSize" | "radius" | "colorTint"> ) {
        super();

        this._pointsFront = new OverlayPointsObject(maxPoints, {
            collectionOpacity: 1, depthMode: LessEqualDepth, ...materialParameters
        });
