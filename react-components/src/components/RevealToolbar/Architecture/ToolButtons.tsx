...
import { FitViewCommand } from '../../../architecture/commands/FitViewCommand';
import { FlexibleControlsType } from '@cognite/reveal';
import { SetFlexibleControlsTypeCommand } from '../../../architecture/commands/SetFlexibleControlsTypeCommand';
