...
import { IconVisualizationMode } from '@reveal/360-images/src/icons/IconCollection';
...
export class Image360ApiHelper {
  ...
  public exit360Image(): void {
    this._image360Facade.allIconsVisibility = true;
    this._image360Facade.allIconVisualizationMode = IconVisualizationMode.Clustered;
