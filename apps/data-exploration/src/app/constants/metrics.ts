...
const THREED_SELECT = {
  ...
  TOGGLE_HIGH_FIDELITY_RENDERING: `${EXPLORATION_PREFIX}.3D.ToggleHighFidelityRendering`,
...
const THREED_ACTION = {
  ...
  POINT_OF_INTEREST_SELECTED: `${EXPLORATION_PREFIX}.3D.PointOfInterestSelected`,
