...
export class ZScaleCommand extends ThreeRenderTargetCommand
{
  ...
  protected /*override*/ getTooltipCore(): string { return "Set Z-scale"; }

  public /*override*/ getName(): string { return "Scale Z"; }
  public /*override*/ get isDropdown(): boolean { return true; }
  public /*override*/ get dropdownOptions(): string[] { return ["0.1", "0.25", "0.5", "1", "1.5", "2", "2.5", "3", "4", "5", "7.5", "10", "20", "50", "100"]; }
