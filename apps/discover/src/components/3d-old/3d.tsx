...
import { mapCasingsTo3D } from 'components/3d-old/3d/casings';
import { mapLogsTo3D } from 'components/3d-old/3d/logs';
import { mapTrajectoriesTo3D } from 'components/3d-old/3d/mapTrajectoriesTo3D';
import { mapTrajectoryDataTo3D } from 'components/3d-old/3d/mapTrajectoryDataTo3D';
import { mapNDSTo3D } from 'components/3d-old/3d/nds';
import { mapNPTTo3D } from 'components/3d-old/3d/npt';
import { mapWellboresTo3D } from 'components/3d-old/3d/wellbores';
import { mapWellsTo3D } from 'components/3d-old/3d/wells';
