...
export const UseImage360EntityContext: Context<UseImage360EntityContextDependencies> =
  createContext<UseImage360EntityContextDependencies>(defaultUseImage360EntityContextDependencies);
