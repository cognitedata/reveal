...
export const DISABLED_TEXT_COLOR = 'lightgray';
export const SELECTED_TEXT_COLOR = 'white';
export const SELECTED_BACKGROUND_COLOR = 'highlight';
export const HOVER_TEXT_COLOR = 'black';
