    ...
    versions: [
      {
        ...
        parameters: [
          {
            default_value: -99999999999999.0,
    ...
    versions: [
      {
        changelog: null,
        deprecated: true,
        description: 'This old function is used only for testing purposes',
        inputs: [
          {
            description: null,
            name: 'Dummy input',
      ...
      },
      {
        ...
        deprecated: true,
        description: 'This new function is used only for testing purposes',
        inputs: [
          {
            description: null,
            name: 'Dummy input',
    ...
    versions: [
      {
        ...
        inputs: [
          ...
          {
            description: 'Temperature time series in degrees Fahrenheit units.',
            name: 'Temperature',
            param: 'temperature',
            types: ['ts'],
          },
    ...
    versions: [
      {
        ...
        parameters: [
          {
            default_value: 'ms',
            description: 'Valid values "ns|us|ms|s|m|h|D|W". Default "ms"',
            name: 'Timestamp unit',
            options: [
              {
                label: 'ns',
