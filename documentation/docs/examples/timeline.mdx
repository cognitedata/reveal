...
We have two options to set additional styles to nodes. First through Dates and through TimelineKeyframes.

#### Set additional Styles for Node through Dates
`setNodeCollectionAndAppearanceByDates(dates: Date | Date[], nodeCollection: NodeCollectionBase, nodeAppearance: NodeAppearance)`
...
timeline.setNodeCollectionAndAppearanceByDates(allDates, stuMechNodes, { renderGhosted: false, color: [80, 100, 120] });
```
#### Set additional Styles for Node through TimelineKeyframes
`setNodeCollectionAndAppearanceByTimelineKeyframes(timelineKeyframes: TimelineKeyframe | TimelineKeyframe[], nodeCollection: NodeCollectionBase, nodeAppearance: NodeAppearance)`
...
timeline.setNodeCollectionAndAppearanceByTimelineKeyframes(allTimelineKeyframes, allPipes, { renderGhosted: false, color: [150, 200, 120] });
```
