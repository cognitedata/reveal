...
import { CogniteClient, CogniteInternalId, Node3D } from '@cognite/sdk';
import { DmsUniqueIdentifier, FdmSDK, InspectResultList } from '../../utilities/FdmSDK';
import { FdmCadEdge } from './types';
