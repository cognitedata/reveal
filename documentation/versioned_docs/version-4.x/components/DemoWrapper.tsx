...
import { env } from '@site/versioned_docs/version-4.x/utils/env';
...
const components: Record<string, ComponentType<DemoProps>> = {
  Cognite3DViewerDemo: React.lazy(() =>
    import('@site/versioned_docs/version-4.x/demos/Cognite3DViewerDemo')
  ),
  ModelPreviewDemo: React.lazy(() =>
    import('@site/versioned_docs/version-4.x/demos/ModelPreviewDemo')
  ),
};
