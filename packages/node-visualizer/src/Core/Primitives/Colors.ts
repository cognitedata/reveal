...
export class Colors {
  ...
  public static get red(): Color {
    return Color.rgb(MaxByte, 0, 0);
  }

  public static get green(): Color {
    return Color.rgb(0, MaxByte, 0);
  }

  public static get blue(): Color {
    return Color.rgb(0, 0, MaxByte);
  }

  public static get yellow(): Color {
    return Color.rgb(MaxByte, MaxByte, 0);
  }

  public static get cyan(): Color {
    return Color.rgb(0, MaxByte, MaxByte);
  }

  public static get magenta(): Color {
    return Color.rgb(MaxByte, 0, MaxByte);
  }

  // Grey scale
  public static get black(): Color {
    return Colors.greyScale(0);
  }

  public static get veryDarkGrey(): Color {
    return Colors.greyScale(0.25);
  }

  public static get darkGrey(): Color {
    return Colors.greyScale(0.5);
  }

  public static get grey(): Color {
    return Colors.greyScale(0.667);
  }

  public static get lightGrey(): Color {
    return Colors.greyScale(0.75);
  }

  public static get white(): Color {
    return Colors.greyScale(1);
  }

  public static greyScale(scale: number): Color {
    return Color.rgb(scale * MaxByte, scale * MaxByte, scale * MaxByte);
  }
  ...
  public static get selectedEmissive(): Color {
    return Color.rgb(128, 128, 0);
  }

  public static get orange(): Color {
    return Color.rgb(MaxByte, 102, 0);
  }
  ...
  private static get colors(): Color[] {
    if (!Colors._colors) Colors._colors = Colors.createDifferentColors(50);
