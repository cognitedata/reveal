...
class Sky extends Mesh {
	...
	constructor() {
	  ...
	  super( new BoxGeometry( 1, 1, 1 ), material /* new MeshBasicMaterial({ color: new Color('red') } ) */);
  ...
  /* onBeforeRender = (
    ...
    camera.lastNear = camera.near;
    camera.lastFar = camera.far;
    camera.near = 0.1;
    camera.far = 10000 + 0.1;
    camera.updateProjectionMatrix();
    console.log('Updated sky');
  };
...
Sky.SkyShader = {
	...
	fragmentShader: /* glsl */`
		...
		void main() {
			...
			gl_FragColor = vec4( retColor / 5.0, 1.0 );
