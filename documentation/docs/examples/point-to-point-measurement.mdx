...
It's possible to toggle between hide & show the measurements in the viewer.
It can be useful to view the details of an object without measurements blocking the view.
