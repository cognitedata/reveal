...
export class AxisGizmoOptions {
  ...
  public lightColors: number[] = [0xf73c3c, 0x6ccb26, 0x178cf0]; // Light color for the X, Y and Z-axis
  public darkColors: number[] = [0x942424, 0x417a17, 0x0e5490]; // Dark color for the X, Y and Z-axis
