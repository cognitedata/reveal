...
export function CalculationRunsList({calculationRuns}: {calculationRuns: CalculationRun[]}){
	const [activeTab, setActiveTab] = useState<string | null>();
	return (
		<Collapse accordion onChange={(currentTab) => {
          ...
          header={
					<CollapseCommonContainer>
						<span>{run.metadata.modelName} v{run.metadata.modelVersion}</span>
