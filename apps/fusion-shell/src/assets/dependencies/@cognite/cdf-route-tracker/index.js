System.register(["@cognite/cdf-sdk-singleton","react"], function(__WEBPACK_DYNAMIC_EXPORT__) {
	var __WEBPACK_EXTERNAL_MODULE__cognite_cdf_sdk_singleton__, __WEBPACK_EXTERNAL_MODULE_react__;
	return {
		setters: [
			function(module) {
				__WEBPACK_EXTERNAL_MODULE__cognite_cdf_sdk_singleton__ = module;
			},
			function(module) {
...
/***/ "./node_modules/@cognite/metrics/dist/index.js":
/*!*****************************************************!*\
  !*** ./node_modules/@cognite/metrics/dist/index.js ***!
  \*****************************************************/
...
var mixpanel = __webpack_require__(/*! mixpanel-browser */ "./node_modules/@cognite/metrics/node_modules/mixpanel-browser/dist/mixpanel.cjs.js");
...
var Timer = /** @class */ (function () {
    function Timer(event, startProps) {
        this.timerEvent = '';
        this.startProps = {};
        this.timerEvent = event;
        this.startProps = startProps;
        try {
            mixpanel__default['default'].time_event(event);
        }
        catch (e) {
            // eslint-disable-next-line no-console
    ...
    Timer.prototype.stop = function (properties, callback) {
        if (properties === void 0) { properties = {}; }
        try {
            var combined = __assign(__assign(__assign({}, globalProperties), this.startProps), properties);
            // Mixpanel modifies their params, so spread the props.
            mixpanel__default['default'].track(this.timerEvent, __assign({}, combined), callback);
...
var Metrics = /** @class */ (function () {
    function Metrics(className, properties, deprecated) {
        if (properties === void 0) { properties = {}; }
        if (deprecated === void 0) { deprecated = true; }
        this.properties = {};
        if (deprecated === true) {
            // eslint-disable-next-line no-console
            console.warn('new Metrics(..) has been deprecated; please use Metrics.create(..) instead.');
        }
        this.className = className;
        this.properties = __assign({}, properties);
    }
    Metrics.init = function (_a) {
        var mixpanelToken = _a.mixpanelToken, debug = _a.debug, metricsDebugger = _a.metricsDebugger, persistence = _a.persistence, properties = __rest(_a, ["mixpanelToken", "debug", "metricsDebugger", "persistence"]);
        if (!mixpanelToken) {
            throw new Error('Missing mixpanelToken parameter');
        }
        mixpanel__default['default'].init(mixpanelToken, {
        ...
        Metrics.props(__assign({ 
            // Log this by default to be able to separate the metrics.
            environment: process.env.REACT_APP_ENV || "development" || 'unknown', 
            // These are auto-populated when built with FAS.
            releaseId: process.env.REACT_APP_RELEASE_ID || 'unknown-release', applicationId: process.env.REACT_APP_APP_ID || 'unknown-app', versionName: process.env.REACT_APP_VERSION_NAME || '0.0.0' }, properties));
    };
    Metrics.optOut = function (options) {
        mixpanel__default['default'].opt_out_tracking(options);
    };
    Metrics.optIn = function (options) {
        mixpanel__default['default'].opt_in_tracking(options);
    };
    Metrics.hasOptedOut = function (options) {
        return mixpanel__default['default'].has_opted_out_tracking(options);
    };
    Metrics.props = function (properties) {
        Object.keys(properties)
            .filter(function (key) { return key !== 'mixpanelToken' && key !== 'debug'; })
            .forEach(function (key) {
            var value = properties[key] || null;
            switch (typeof value) {
                case 'string':
                case 'number':
                case 'boolean':
                ...
                default:
                    if (value === null) {
                        ...
                        /* eslint-disable-next-line no-console */
                        console.warn("Not adding { \"" + key + "\": \"" + (Metrics.DEBUGGER.isDebug ? value : '<value>') + "\" } to the metrics. Only simple data types are supported.");
    ...
    Metrics.identify = function (uid) {
        mixpanel__default['default'].identify(uid);
    };
    Metrics.people = function (info) {
        mixpanel__default['default'].people.set(info);
    };
    Metrics.create = function (className, properties) {
        return new Metrics(className, properties, false);
    };
    Metrics.stop = function (possibleTimer, properties, callback) {
        if (properties === void 0) { properties = {}; }
        if (Metrics.DEBUGGER.isDebug || (possibleTimer && possibleTimer.stop)) {
            possibleTimer.stop(properties, callback);
        }
    };
    Metrics.prototype.getEventString = function (name) {
        if (this.className) {
            return this.className + "." + name;
        }
        return name;
    };
    Metrics.prototype.start = function (name, properties) {
        if (properties === void 0) { properties = {}; }
        return new Timer(this.getEventString(name), __assign(__assign({}, this.properties), properties));
    };
    Metrics.prototype.track = function (name, properties, callback) {
        if (properties === void 0) { properties = {}; }
        var combined = __assign(__assign(__assign({}, globalProperties), this.properties), properties);
        try {
            var event_1 = this.getEventString(name);
            // Mixpanel modifies their params, so spread the props.
            mixpanel__default['default'].track(event_1, __assign({}, combined), callback);
            Metrics.DEBUGGER.track(event_1, combined);
        }
        catch (e) {
            /* eslint-disable-next-line no-console */
    ...
    Metrics.DEBUGGER = NoopDebugger;
    return Metrics;
}());

// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
var useMetrics = (function (componentName, props) {
    var metrics = react.useState(function () { return Metrics.create(componentName, props); })[0];
    return metrics;
});
...
/***/ "./node_modules/@cognite/metrics/node_modules/mixpanel-browser/dist/mixpanel.cjs.js":
/*!******************************************************************************************!*\
  !*** ./node_modules/@cognite/metrics/node_modules/mixpanel-browser/dist/mixpanel.cjs.js ***!
  \******************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/systemjs-webpack-interop/resource-query-public-path.js?systemjsModuleName=%40cognite%2Fcdf-route-tracker&rootDirectoryLevel=1":
/*!****************************************************************************************************************************************************!*\
  !*** ./node_modules/systemjs-webpack-interop/resource-query-public-path.js?systemjsModuleName=%40cognite%2Fcdf-route-tracker&rootDirectoryLevel=1 ***!
  \****************************************************************************************************************************************************/
/*! no exports provided */
...
/* WEBPACK VAR INJECTION */(function(__resourceQuery) {/* harmony import */ var _public_path__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./public-path */ "./node_modules/systemjs-webpack-interop/public-path.js");
...
Object(_public_path__WEBPACK_IMPORTED_MODULE_0__["setPublicPath"])(
  decodeURIComponent(queryObj.systemjsModuleName),
  Number(queryObj.rootDirectoryLevel)
);

/* WEBPACK VAR INJECTION */}.call(this, "?systemjsModuleName=%40cognite%2Fcdf-route-tracker&rootDirectoryLevel=1"))

/***/ }),

/***/ "./src/cognite-cdf-route-tracker.ts":
/*!******************************************!*\
  !*** ./src/cognite-cdf-route-tracker.ts ***!
  \******************************************/
...
/* harmony import */ var _tracker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tracker */ "./src/tracker/index.ts");
/* harmony import */ var _set_public_path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./set-public-path */ "./src/set-public-path.ts");


var metrics = Object(_tracker__WEBPACK_IMPORTED_MODULE_0__["default"])();
 ...
 */
Object(systemjs_webpack_interop__WEBPACK_IMPORTED_MODULE_0__["setPublicPath"])('@cognite/cdf-route-tracker');
...
/*!******************************!*\
  !*** ./src/tracker/index.ts ***!
  \******************************/
/*! exports provided: checkUrl, isDevelopment, isStaging, isProduction, getCluster, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _cognite_cdf_sdk_singleton__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @cognite/cdf-sdk-singleton */ "@cognite/cdf-sdk-singleton");
/* harmony import */ var _cognite_cdf_sdk_singleton__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_cognite_cdf_sdk_singleton__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _cognite_metrics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @cognite/metrics */ "./node_modules/@cognite/metrics/dist/index.js");
/* harmony import */ var _cognite_metrics__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_cognite_metrics__WEBPACK_IMPORTED_MODULE_1__);
...
// fusion token
var mixpanelToken = '5c4d853e7c3b77b1eb4468d5329b278c'; // pragma: allowlist secret
var checkUrl = function checkUrl(env) {
  return window.location.hostname.includes(env);
};
var isDevelopment = function isDevelopment() {
  return checkUrl('dev') || checkUrl('localhost');
};
var isStaging = function isStaging() {
  return checkUrl('staging') || checkUrl('pr') || checkUrl('next-release');
};
var isProduction = function isProduction() {
  return !(isStaging() || isDevelopment());
};
var getCluster = function getCluster(search) {
...
var disableTracking = function disableTracking() {
  var DONT_TRACK_ME_DOMAINS = ['statnett.fusion.cognite.com'];
  var DONT_TRACK_ME_CLUSTERS = ['statnett.cognitedata.com', 'power-no.cognitedata.com', 'az-power-no-northeurope.cognitedata.com'];
  var cluster = getCluster(window.location.search);
  return DONT_TRACK_ME_CLUSTERS.includes(cluster) || DONT_TRACK_ME_DOMAINS.includes(window.location.hostname);
};
var tracker = function tracker() {
  var metrics;
  var identified = false;
  var track = function track(name, options) {
    if (disableTracking()) {
      return;
    }
    var hostname = window.location.hostname;
    var customerDomain = hostname.split('.')[0];
    var fusionDomain = hostname.split('.').slice(1).join('.');
    if (!metrics) {
      _cognite_metrics__WEBPACK_IMPORTED_MODULE_1__["Metrics"].init({
      ...
      _cognite_metrics__WEBPACK_IMPORTED_MODULE_1__["Metrics"].optIn();
      metrics = _cognite_metrics__WEBPACK_IMPORTED_MODULE_1__["Metrics"].create();
    }
    var pathname = window.location.pathname;
    var project = pathname.split('/')[1];
    var props = __assign(__assign({}, options), {
      pathname: pathname,
      project: project
    });
    if (identified) {
      ...
      Object(_cognite_cdf_sdk_singleton__WEBPACK_IMPORTED_MODULE_0__["getUserInformation"])().then(function (_a) {
        var id = _a.id,
          mail = _a.mail,
          userPrincipalName = _a.userPrincipalName,
          displayName = _a.displayName;
        identified = true;
        if (id) {
          _cognite_metrics__WEBPACK_IMPORTED_MODULE_1__["Metrics"].identify(id);
          _cognite_metrics__WEBPACK_IMPORTED_MODULE_1__["Metrics"].people({
            id: id,
            name: displayName,
...
/***/ 0:
/*!******************************************************************************************************************************************************************************************!*\
  !*** multi ./node_modules/systemjs-webpack-interop/resource-query-public-path?systemjsModuleName=%40cognite%2Fcdf-route-tracker&rootDirectoryLevel=1 ./src/cognite-cdf-route-tracker.ts ***!
  \******************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/branko.dimitrijoski@cognitedata.com/Desktop/cognite/cdf-ui-hub/packages/cdf-hub-route-tracker/node_modules/systemjs-webpack-interop/resource-query-public-path?systemjsModuleName=%40cognite%2Fcdf-route-tracker&rootDirectoryLevel=1 */"./node_modules/systemjs-webpack-interop/resource-query-public-path.js?systemjsModuleName=%40cognite%2Fcdf-route-tracker&rootDirectoryLevel=1");
module.exports = __webpack_require__(/*! /Users/branko.dimitrijoski@cognitedata.com/Desktop/cognite/cdf-ui-hub/packages/cdf-hub-route-tracker/src/cognite-cdf-route-tracker.ts */"./src/cognite-cdf-route-tracker.ts");
...
/*!*********************************************!*\
  !*** external "@cognite/cdf-sdk-singleton" ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE__cognite_cdf_sdk_singleton__;
