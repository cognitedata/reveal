...
import { SpacedRow, ButtonGroup, Divider } from 'lib/components';
...
export const RangePicker = ({
  ...
  const maxHeight = useMemo(() => {
    return Math.max(window.innerHeight - offsetTop - offsetHeight - 100, 300);
          ...
          <Button
            ...
            onClick={() => {
              if (mode === 'range') {
                ...
                onRangeChanged([
                  startEndRange.startDate,
                  startEndRange.endDate,
                ]);
              }
            }}
          >
