...
docker run -e IDP_TOKEN_ID=explorer-e2e -p 8200:8200 -e PORT=8200 -e PRIVATE_KEYS_PATH=/private-keys -v $(pwd)/private-keys:/private-keys eu.gcr.io/cognitedata/fake-idp:latest
