...
export const useEditRuleInstance = (): ((ruleOutputSet: RuleOutputSet) => Promise<ExternalIdsResultList<unknown>>) => {
  const fdmSdk = useFdmSdk();

  const editCurrentRule = useCallback(async (ruleOutputSet: RuleOutputSet): Promise<ExternalIdsResultList<unknown>> => {
