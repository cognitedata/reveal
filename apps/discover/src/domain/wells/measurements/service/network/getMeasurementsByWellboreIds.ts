...
import { getDepthMeasurementData } from './getDepthMeasurementData';
import { getDepthMeasurements } from './getDepthMeasurements';
...
export const getMeasurementsByWellboreIds = async (
  ...
  const depthMeasurementPromises = getDepthMeasurements({
    wellboreMatchingIds,
    measurementTypes: [
