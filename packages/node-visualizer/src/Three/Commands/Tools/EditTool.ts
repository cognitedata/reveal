...
export class EditTool extends BaseTool {
  ...
  public /* override */ overrideLeftButton(): boolean {
    return true;
  }
  ...
  public /* override */ onMouseDown(event: MouseEvent): void {
    ...
    const manipulator = ManipulatorFactory.instance.create(
      node,
      target.className
    );
    ...
    if (!manipulator.onMouseDown(target, node, intersection, ray)) return;
  ...
  public /* override */ onMouseDrag(event: MouseEvent): void {
    ...
    if (!this._currentManipulator) return;
