...
import { CdfModelIdentifier, FdmIdentifier, File3dFormat } from '@reveal/data-providers';
...
export class Cognite3DViewer {
   ...
   * @param eventFilter The search parameters to apply when querying Cognite Datamodels that contains the 360 images.
   */
  async add360ImageSet(datasource: 'datamodels', dataModelIdentifier: FdmIdentifier): Promise<Image360Collection>;
  /**
  ...
  async add360ImageSet(
    ...
    sourceParameters: { [key: string]: string } | FdmIdentifier,
    add360ImageOptions?: AddImage360Options
  ): Promise<Image360Collection> {
