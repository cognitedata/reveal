...
import { ResourcePreviewSidebarUFV } from '@data-exploration-components/containers/ResourceSidebarUFV';
...
const ResourcePreviewContextUFV = React.createContext(
  {} as ResourcePreviewObserver
);

export const useResourcePreviewUFV = () => {
  const observer = useContext(ResourcePreviewContextUFV);
  return observer;
};

export const ResourcePreviewProviderUFV = ({
  children,
}: {
  ...
  return (
    <ResourcePreviewContextUFV.Provider
      value={{
        openPreview,
        hidePreview,
      }}
...
export default ResourcePreviewContextUFV;
