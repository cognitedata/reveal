...
export class ViewFromCommand extends ThreeRenderTargetCommand {
  ...
  public /* override */ getName(): string {
    return `View from ${this.directionName}`;
  }
  ...
  public /* override */ getIcon(): string {
    switch (this.viewFrom) {
      case -1:
        return '';
      case 0:
        return ViewFromCommandTopIcon;
      case 1:
        return ViewFromCommandBottomIcon;
      case 2:
        return ViewFromCommandSouthIcon;
      case 3:
        return ViewFromCommandNorthIcon;
      case 4:
        return ViewFromCommandWestIcon;
      case 5:
        return ViewFromCommandEastIcon;
      default:
        return '';
    }
  }
