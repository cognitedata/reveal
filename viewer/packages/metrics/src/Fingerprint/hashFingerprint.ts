export function hashFingerprint(str: string, seed = 0): number {
  ...
  firstPointer =
    Math.imul(firstPointer ^ (firstPointer >>> 16), 2246822507) ^
    Math.imul(secondPointer ^ (secondPointer >>> 13), 3266489909);
  secondPointer =
    Math.imul(secondPointer ^ (secondPointer >>> 16), 2246822507) ^
    Math.imul(firstPointer ^ (firstPointer >>> 13), 3266489909);
