...
(a right handed, Y up coordiante system)[https://www.youtube.com/watch?v=TGbMzoJqV7c] - which might differ 
from the "native model coordinates" store in Cognite Fusion. `ByAssetNodeSet` will automatically map from 
