...
export class CameraManagerHelper {
    ...
    */
    ...
    calculateNewTargetFromRotation(camera: THREE.PerspectiveCamera, rotation: THREE.Quaternion, currentTarget: THREE.Vector3): THREE.Vector3 {
    ...
    calculateCameraStateToFitBoundingBox(camera: THREE.PerspectiveCamera, box: THREE.Box3, radiusFactor: number = 2): {position: THREE.Vector3, target: THREE.Vector3} {
