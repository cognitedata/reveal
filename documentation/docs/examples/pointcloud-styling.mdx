...
To revert an assignment of a style to an object collection, you may use `model.unassignStyledObjectCollection`, using the `PointCloudObjectCollection` as argument. To reset all styled objects use `model.removeAllStyledCollections`
