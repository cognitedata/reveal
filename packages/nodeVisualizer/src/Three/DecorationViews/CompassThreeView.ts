...
export class CompassThreeView extends BaseGroupThreeView {
  ...
  protected get node(): CompassNode { return super.getNode() as CompassNode; }
  ...
  protected /* virtual */ get scene(): THREE.Scene { return this.renderTarget.miniWindowScene; }
  ...
  private createSolid(top: boolean): THREE.Object3D {
    ...
    const material = new THREE.MeshStandardMaterial({ 
      ...
      flatShading: true,
      color: ThreeConverter.toThreeColor(top ? CompassThreeView.topColor : CompassThreeView.bottomColor)
    });
