...
const existProperty1 = [
  simpleSourcesFixtures[0].space,
  `${simpleSourcesFixtures[0].externalId}/${simpleSourcesFixtures[0].version}`,
  'object3D'
];
const existProperty2 = [
  simpleSourcesFixtures[1].space,
  `${simpleSourcesFixtures[1].externalId}/${simpleSourcesFixtures[1].version}`,
  'object3D'
];
...
export const validInstanceFiltersForMappedAssetsQueryPayload = {
  and: [
    {
      hasData: [simpleSourcesFixtures[0], simpleSourcesFixtures[1]]
    },
    {
      exists: {
        property: [
