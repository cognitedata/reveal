...
as a result of this. To best utilize the filtering APIs we recommend providing a rich 3D models 
...
Or, using two separate queries that are combined:
...
the user will want to show 'PIPE'-nodes within the 'STU'-purpose, it might 
