...
describe(usePointCloudDMVolumeMappingForAssetInstances.name, () => {
  ...
  test('calls usePointCloudModelRevisionIdsFromReveal', () => {
  ...
  test('calls useModelIdRevisionIdFromModelOptions with correct models', () => {
  ...
  test('calls usePointCloudDMVolumes with correct model options', () => {
    renderHook(() => usePointCloudDMVolumeMappingForAssetInstances([assetInstance1]), {
      wrapper
    });
